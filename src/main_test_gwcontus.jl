...
optprob = problem(m, [:Allocation, :Allocation, :Allocation, :Reservoir], [:waterfromreservoir, :waterfromgw, :waterfromsupersource, :outflows], [0., 0., 0., 0.], [1e9,1e9,1e12,1e9], objective, constraints=constraints, algorithm=:GUROBI_LINPROG);
println("Solving...")
