...
regions = CSV.read(loadpath("county-info.csv"), eltypes=[String, String, String, String, Float64, Float64, Float64, Float64, Float64, Float64, Float64])
...
if get(config, "dataset", "counties") == "paleo"
    precip = zeros(getmaxsteps(), nrow(masterregions))
else
