...
constcomps = [:Agriculture,:Agriculture, :WaterNetwork, :Allocation,:Agriculture]
constraints = [:totalirrigated,:totalrainfed, :outflows, :balance,:totalproduction]
...
if redohouse
    ...
    # Constrain irrigated < total irrigated
    setconstraint!(house, grad_agriculture_totalirrigated_irrigatedareas(m)) # +
    setconstraintoffset!(house, constraintoffset_agriculture_totalirrigated(m))


    # Constrain rainfed < total rainfed
    setconstraint!(house, grad_agriculture_totalrainfed_rainfedareas(m)) # +
    setconstraintoffset!(house, constraintoffset_agriculture_totalrainfed(m))
    ...
    setconstraintoffset!(house,-constraintoffset_fixed_agriculture_cropdemand(m))#-
