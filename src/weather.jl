...
regions = readtable(datapath("county-info.csv"), eltypes=[UTF8String, UTF8String, UTF8String, UTF8String, Float64, Float64, Float64, Float64, Float64, Float64, Float64])
...
if config["ncregion"] == "county"
    ...
    waternetwork2 = DataFrame(gaugeid=UTF8String[], lat=Float64[], lon=Float64[])
