...
function grad_agriculture_allagarea_irrcropareas(m::Model) #NOT USED IN COLORADO 
...
function grad_agriculture_allagarea_unicropareas(m::Model) #NOT USED IN COLORADO 
    function generate(A, tt)
        for rr in 1:numcounties
