...
function constraintoffset_waterright_swrighttotal(m::Model)
    hallsingle(m, :WaterRight, :swtotal, (rr) -> m.md.external_params[:WaterRight_swrighttotal].values[rr])
end
...
function constraintoffset_waterright_gwrighttotal(m::Model)
    hallsingle(m, :WaterRight, :gwtotal, (rr) -> m.md.external_params[:WaterRight_gwrighttotal].values[rr])
end
