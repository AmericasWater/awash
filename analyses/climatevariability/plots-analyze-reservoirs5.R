...
result_path = paste0("C:/Users/luc/Desktop/awash/analyses/climatevariability/", "paper3/paleo_1564-1573/")
start_year=1564
end_year=1573
simyrs=10
failure_file="failure-surface-propenv0.5-rescapzero-norightconst-yearly-1564.csv"
nlocs=3109
...
dir.create('plots/yearly', showWarnings=F)
