...
cultivation_costs = Dict("corn" => 270.71, "corn.co.rainfed" =>270.71, "corn.co.irrigated" => 270.71,
                         "sorghum" =>127.13, "soybeans" => 125.47,
"wheat" => 109.18, "wheat.co.rainfed" => 109.18, "wheat.co.irrigated" =>109.18,
"hay" => 317,"barley"=>131.856) # USD / acre (ALL Operating and Overhead Cost -Land - Unpaid Labor) 

overhead_costs = Dict("corn" => 224.71, "corn.co.rainfed" =>224.71, "corn.co.irrigated" => 224.71,
                         "sorghum" =>162.11, "soybeans" => 197.15,
"wheat" => 155.78, "wheat.co.rainfed" => 155.78, "wheat.co.irrigated" => 155.7,
"hay" => 167,"barley"=>231.21)


maximum_yields = Dict("alfalfa" => 25., "otherhay" => 25., "Hay" => 10,
...
crop_prices = Dict("alfalfa" => 138.2, # alfalfa
                   "otherhay" => 138.2, # otherhay
"hay"=>138.2,                   
"Barley" => 4.05, # barley
                   "Barley.Winter" => 4.05, # barley.winter
                   "Maize" => 3.96, # maize
                   "Sorghum" => 3.68, # sorghum: $/MT / lb/MT
                   "Soybeans" => 8.95, # soybeans
                   "Wheat" => 5.46, # wheat
                   "Wheat.Winter" => 5.46,
                   "corn.co.rainfed"=>3.96,
"corn.co.irrigated"=>3.96, "wheat.co.rainfed" =>5.46 ,"wheat.co.irrigated" =>5.46
                    ) # wheat.winter
...
function read_nareshyields(crop::AbstractString)
    ...
    for ii in 1:numsteps
        result[regionindices, ii] = exp(vec(convert(Matrix{Float64}, yields[index2year(ii) - 1949, :])))
    end
